...
\begin{document}
  ...
  \include{contido/introduction}
  \include{contido/methodology}
  \include{contido/current-infrastructure}
  \include{contido/state-of-the-art}
  \include{contido/technology-selection}
  \include{contido/hosting-provider}
  \include{contido/implementation}
